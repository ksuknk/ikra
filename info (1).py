...
def start(message):
    bot.send_message(message.chat.id, "Для запуска (перезапуска) бота, напиши команду /start."
                                           "Для прохождения теста, напиши команду /test"
                                           "Ну я думаю хватит команд,проходите тест :)")
